...
public class Task6_SalaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        int s = (weeklyHours * 52) * hourlyRate;

        System.out.println("Hello " + name + ", your salary is $" + s);
...
2. Declare the following Variables:
        ...
        2. hourlyRate
        3. weeklyHours
3. Write a program that can calculate the salary,and display
the following info:
    Hint: there are 52 weeks in a year
        salary = hourlyRate * weeklyHours * 52
Ex:
    given data:
        name = “Joshua” hourlyRate = 40
        weeklyHours = 45
    output:
